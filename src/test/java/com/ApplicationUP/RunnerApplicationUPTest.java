...
@CucumberOptions(
    features = "src/test/resources/com/ApplicationUP/ValidateAplicationUP.feature", // Location of the feature files
    glue = "com.ApplicationUP",     // Location of the step definitions java file 
  //dryRun=false,
    //monochrome=true,
    plugin = {
